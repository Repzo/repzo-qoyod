...
export const create_invoice = async (event, options) => {
    ...
    try {
        ...
        if (!((_c = qoyod_client.integration_meta) === null || _c === void 0 ? void 0 : _c.qoyod_id))
        ...
        if (!((_d = repzo_invoice_warehouse.integration_meta) === null || _d === void 0 ? void 0 : _d.qoyod_id))
        ...
        for (let i = 0; i < repzo_invoice.items.length; i++) {
            ...
            if (!((_e = repzo_variant === null || repzo_variant === void 0 ? void 0 : repzo_variant.integration_meta) === null || _e === void 0 ? void 0 : _e.qoyod_id))
            ...
            if (!((_f = repzo_measureunit === null || repzo_measureunit === void 0 ? void 0 : repzo_measureunit.integration_meta) === null || _f === void 0 ? void 0 : _f.qoyod_id))
            ...
            qoyod_invoice_items.push({
                product_id: (_g = repzo_variant === null || repzo_variant === void 0 ? void 0 : repzo_variant.integration_meta) === null || _g === void 0 ? void 0 : _g.qoyod_id,
                description: "",
                quantity: repzo_item.qty,
                unit_price: repzo_item.discounted_price / 1000,
                unit_type: (_h = repzo_measureunit === null || repzo_measureunit === void 0 ? void 0 : repzo_measureunit.integration_meta) === null || _h === void 0 ? void 0 : _h.qoyod_id,
        ...
        const qoyod_invoice_body = {
            invoice: {
                contact_id: (_j = qoyod_client.integration_meta) === null || _j === void 0 ? void 0 : _j.qoyod_id,
                ...
                status: (_l = (_k = options === null || options === void 0 ? void 0 : options.data) === null || _k === void 0 ? void 0 : _k.invoices) === null || _l === void 0 ? void 0 : _l.invoiceInitialStatus,
                inventory_id: (_m = repzo_invoice_warehouse.integration_meta) === null || _m === void 0 ? void 0 : _m.qoyod_id,
