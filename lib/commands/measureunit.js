...
export const sync_measureunits = async (commandEvent) => {
    ...
    try {
        ...
        result.qoyod_total = (_b = qoyod_units === null || qoyod_units === void 0 ? void 0 : qoyod_units.product_unit_types) === null || _b === void 0 ? void 0 : _b.length;
        await commandLog
            .addDetail(`${(_c = qoyod_units === null || qoyod_units === void 0 ? void 0 : qoyod_units.product_unit_types) === null || _c === void 0 ? void 0 : _c.length} taxes changed since ${commandEvent.app.options_formData[bench_time_key] || "ever"}`)
            .commit();
        ...
        result.repzo_total = (_d = repzo_units === null || repzo_units === void 0 ? void 0 : repzo_units.data) === null || _d === void 0 ? void 0 : _d.length;
        await commandLog
            .addDetail(`${(_e = repzo_units === null || repzo_units === void 0 ? void 0 : repzo_units.data) === null || _e === void 0 ? void 0 : _e.length} taxes in Repzo was matched the integration.id`)
            .commit();
        for (let i = 0; i < qoyod_units.product_unit_types.length; i++) {
            ...
            if (!repzo_unit) {
                ...
                try {
                    ...
                    result.failed_msg.push("Create Measure Unit Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                    result.failed++;
                }
            }
            else {
                const found_identical_docs = db.search({
                    id: (_f = repzo_unit.integration_meta) === null || _f === void 0 ? void 0 : _f.qoyod_id,
                ...
                try {
                    ...
                    console.log("Update Measure Unit Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                    result.failed_msg.push("Update Measure Unit Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                    result.failed++;
                }
            }
        }
