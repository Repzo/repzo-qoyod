...
export const sync_taxes = async (commandEvent) => {
    ...
    try {
        ...
        result.qoyod_total = (_b = qoyod_taxes === null || qoyod_taxes === void 0 ? void 0 : qoyod_taxes.taxes) === null || _b === void 0 ? void 0 : _b.length;
        ...
        await commandLog
            .addDetail(`${(_d = qoyod_taxes === null || qoyod_taxes === void 0 ? void 0 : qoyod_taxes.taxes) === null || _d === void 0 ? void 0 : _d.length} taxes changed since ${commandEvent.app.options_formData[bench_time_key] || "ever"}`)
            .addDetail(`${(_e = repzo_taxes === null || repzo_taxes === void 0 ? void 0 : repzo_taxes.data) === null || _e === void 0 ? void 0 : _e.length} taxes in Repzo was matched the integration.id`)
            .commit();
        for (let i = 0; i < qoyod_taxes.taxes.length; i++) {
            const qoyod_tax = qoyod_taxes.taxes[i];
            const repzo_tax = repzo_taxes.data.find((r_tax) => {
                var _a;
                return ((_a = r_tax.integration_meta) === null || _a === void 0 ? void 0 : _a.id) ==
            ...
            if (!repzo_tax) {
                ...
                try {
                    ...
                    result.failed_msg.push("Create Tax Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                ...
                const found_identical_docs = db.search({
                    id: (_f = repzo_tax.integration_meta) === null || _f === void 0 ? void 0 : _f.qoyod_id,
                    name: repzo_tax.name,
                    percentage: (_g = repzo_tax.integration_meta) === null || _g === void 0 ? void 0 : _g.percentage,
                });
                ...
                try {
                    ...
                    console.log("Update Tax Failed >> ", (_h = e === null || e === void 0 ? void 0 : e.response) === null || _h === void 0 ? void 0 : _h.data, body);
                    result.failed_msg.push("Update Tax Failed >> ", (_j = e === null || e === void 0 ? void 0 : e.response) === null || _j === void 0 ? void 0 : _j.data, body);
                    result.failed++;
                }
            }
        }
        ...
        //@ts-ignore
        console.error((_k = e === null || e === void 0 ? void 0 : e.response) === null || _k === void 0 ? void 0 : _k.data);
