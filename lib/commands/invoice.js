...
export const sync_invoice = async (commandEvent) => {
    ...
    try {
        ...
        if (!((_b = repzo_invoice.client_id.integration_meta) === null || _b === void 0 ? void 0 : _b.qoyod_id))
        ...
        for (let i = 0; i < repzo_invoice.items.length; i++) {
            ...
            const repzo_variant = repzo_variants.data.find((variant) => variant._id == repzo_item.variant.variant_id._id);
            if (!((_d = repzo_variant === null || repzo_variant === void 0 ? void 0 : repzo_variant.integration_meta) === null || _d === void 0 ? void 0 : _d.qoyod_id))
                throw new Error(`Sync Invoice Failed >> invoice.item.variant ${repzo_item.variant.variant_id._id} was missed the integration.qoyod_id`);
        ...
        const qoyod_invoice_body = {
            invoice: {
                contact_id: (_h = repzo_invoice.client_id.integration_meta) === null || _h === void 0 ? void 0 : _h.qoyod_id,
        ...
        const qoyod_invoice = await _create(commandEvent.app.available_app.app_settings.serviceEndPoint, "/invoices", qoyod_invoice_body, { "API-KEY": commandEvent.app.formData.serviceApiKey });
