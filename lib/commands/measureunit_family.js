...
export const sync_measureunit_family = async (commandEvent) => {
    ...
    try {
        ...
        result.qoyod_total_families = (_b = qoyod_products === null || qoyod_products === void 0 ? void 0 : qoyod_products.products) === null || _b === void 0 ? void 0 : _b.length;
        await commandLog
            .addDetail(`${(_c = qoyod_products === null || qoyod_products === void 0 ? void 0 : qoyod_products.products) === null || _c === void 0 ? void 0 : _c.length} Products was found`)
            .commit();
        ...
        await commandLog
            .addDetail(`${(_d = qoyod_units === null || qoyod_units === void 0 ? void 0 : qoyod_units.product_unit_types) === null || _d === void 0 ? void 0 : _d.length} Units was found`)
            .commit();
        ...
        await commandLog
            .addDetail(`${(_e = repzo_measureunits === null || repzo_measureunits === void 0 ? void 0 : repzo_measureunits.data) === null || _e === void 0 ? void 0 : _e.length} Measure Units was found`)
            .commit();
        for (let key in unique_measureunits) {
            const qoyod_measureunit = unique_measureunits[key];
            const repzo_measureunit = (_f = repzo_measureunits === null || repzo_measureunits === void 0 ? void 0 : repzo_measureunits.data) === null || _f === void 0 ? void 0 : _f.find((repzo_unit) => {
                var _a;
        ...
        await commandLog
            .addDetail(`${(_g = repzo_measureunit_families === null || repzo_measureunit_families === void 0 ? void 0 : repzo_measureunit_families.data) === null || _g === void 0 ? void 0 : _g.length} Measure Unit Family was found`)
            .commit();
        ...
        for (let i = 0; i < measureunit_families.length; i++) {
            ...
            if (!repzo_family) {
                ...
                try {
                    ...
                    result.failed_msg.push("Create Measure Unit Family Failed >> ", e === null || e === void 0 ? void 0 : e.response, qoyod_family);
                    result.failed++;
                }
            }
            else {
                ...
                const has_all_measureunits = found_identical_docs.length &&
                    ((_h = found_identical_docs[0].measureunits) === null || _h === void 0 ? void 0 : _h.length) ==
                ...
                try {
                    ...
                    result.failed_msg.push("Update Measure Unit Failed >> ", e === null || e === void 0 ? void 0 : e.response, qoyod_family);
                    result.failed++;
                }
            }
        }
        ...
        //@ts-ignore
        console.error((_j = e === null || e === void 0 ? void 0 : e.response) === null || _j === void 0 ? void 0 : _j.data);
