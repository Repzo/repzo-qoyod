...
export const addClients = async (commandEvent) => {
    ...
    try {
        ...
        const qoyod_clients = await get_qoyod_clients(commandEvent.app.available_app.app_settings.serviceEndPoint, commandEvent.app.formData.serviceApiKey, updateAt_query("?q[status_eq]=Active", commandEvent.app.options_formData, bench_time_key));
        result.qoyod_total = (_b = qoyod_clients === null || qoyod_clients === void 0 ? void 0 : qoyod_clients.customers) === null || _b === void 0 ? void 0 : _b.length;
        await commandLog
            .addDetail(`${(_c = qoyod_clients === null || qoyod_clients === void 0 ? void 0 : qoyod_clients.customers) === null || _c === void 0 ? void 0 : _c.length} clients changed since ${commandEvent.app.options_formData[bench_time_key] || "ever"}`)
            .commit();
        ...
        result.repzo_total = (_d = repzo_clients === null || repzo_clients === void 0 ? void 0 : repzo_clients.data) === null || _d === void 0 ? void 0 : _d.length;
        await commandLog
            .addDetail(`${(_e = repzo_clients === null || repzo_clients === void 0 ? void 0 : repzo_clients.data) === null || _e === void 0 ? void 0 : _e.length} clients in Repzo was matched the integration.id`)
            .commit();
        for (let i = 0; i < qoyod_clients.customers.length; i++) {
            ...
            if (!repzo_client) {
                ...
                try {
                    ...
                    result.failed_msg.push("Create Client Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                    result.failed++;
                }
            }
            else {
                ...
                try {
                    ...
                    result.failed_msg.push("Update Client Failed >> ", e === null || e === void 0 ? void 0 : e.response, body);
                    result.failed++;
                }
            }
        }
        ...
        //@ts-ignore
        console.error((_f = e === null || e === void 0 ? void 0 : e.response) === null || _f === void 0 ? void 0 : _f.data);
...
export const updatedInactiveClients = async (commandEvent) => {
    ...
    try {
        ...
        const qoyod_clients = await get_qoyod_clients(commandEvent.app.available_app.app_settings.serviceEndPoint, commandEvent.app.formData.serviceApiKey, updateAt_query("?q[status_eq]=Inactive", commandEvent.app.options_formData, bench_time_key));
        result.qoyod_total = (_b = qoyod_clients === null || qoyod_clients === void 0 ? void 0 : qoyod_clients.customers) === null || _b === void 0 ? void 0 : _b.length;
        await commandLog
            .addDetail(`${(_c = qoyod_clients === null || qoyod_clients === void 0 ? void 0 : qoyod_clients.customers) === null || _c === void 0 ? void 0 : _c.length} clients changed since ${commandEvent.app.options_formData[bench_time_key] || "ever"}`)
            .commit();
        ...
        for (let i = 0; i < qoyod_clients.customers.length; i++) {
            ...
            if (repzo_client) {
                ...
                try {
                    ...
                    result.failed_msg.push("Disable Client Failed >> ", e === null || e === void 0 ? void 0 : e.response, {
