...
export const updatedInactiveClients = async (commandEvent) => {
  ...
  try {
    ...
    const pageSize = 100;
    const repzo_clients_data = [];
    for (
      let page = 0;
      page < Math.ceil(qoyod_clients.customers.length / pageSize);
      page++
    ) {
      ...
      if (
        repzo_clients_batch === null || repzo_clients_batch === void 0
          ? void 0
          : repzo_clients_batch.data
      ) {
